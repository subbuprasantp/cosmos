...
var stableStringify = _interopDefault(require('fast-json-stable-stringify'));
...
// Copyright (c) Microsoft Corporation.
function generateHeaders(masterKey, method, resourceType = exports.ResourceType.none, resourceId = "", date = new Date()) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
...
function setAuthorizationHeader(clientOptions, verb, path, resourceId, resourceType, headers) {
    ...
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        if (clientOptions.key) {
            ...
            const token = yield clientOptions.aadCredentials.getToken(`${hrefEndpoint}/.default`);
...
function decorateOperation(operation, definition, options = {}) {
    if (operation.operationType === BulkOperationType.Create ||
        ...
        if ((operation.resourceBody.id === undefined || operation.resourceBody.id === "") &&
            ...
            operation.resourceBody.id = uuid.v4();
        }
    }
    ...
    bulk(operations, bulkOptions, options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(batches
                ...
                .map((batch) => tslib.__awaiter(this, void 0, void 0, function* () {
...
function httpRequest(requestContext) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        const url$1 = trimSlashes(requestContext.endpoint) + requestContext.path;
        ...
        try {
            response = yield httpsClient.sendRequest(pipelineRequest);
        }
        catch (error) {
        ...
        clearTimeout(timeout);
        const result = response.status === 204 || response.status === 304 ? null : JSON.parse(response.bodyAsText);
...
class ClientContext {
    ...
    queryFeed({ path, resourceType, resourceId, resultFn, query, options, partitionKeyRangeId, partitionKey }) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if (query !== undefined) {
                request$1.method = exports.HTTPMethod.post;
            }
            request$1.endpoint = yield this.globalEndpointManager.resolveServiceEndpoint(request$1.resourceType, request$1.operationType);
            request$1.headers = yield this.buildHeaders(request$1);
            if (query !== undefined) {
